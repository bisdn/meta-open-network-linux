...
SRC_URI += " \
           ...
           file://bigcode/0005-sff-drop-dependmodules.x-include.patch;patchdir=${SUBMODULE_BIGCODE} \
           file://bigcode/0006-sff-add-missing-include-to-cJSON.h.patch;patchdir=${SUBMODULE_BIGCODE} \
